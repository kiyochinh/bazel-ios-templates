...
http_archive(
    ...
    build_file = "@//:third-party/Alamofire/BUILD",
...
http_archive(
    ...
    build_file = "@//:third-party/RxSwift/BUILD",
...
http_archive(
    ...
    build_file = "@//:third-party/ObjectMapper/BUILD",
...
http_archive(
    ...
    build_file = "@//:third-party/IQKeyboardManager/BUILD",
